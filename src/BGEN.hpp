...
public:
  ...
  double Parse(unsigned char * buf, size_t bufLen,  std::string & snpName, unsigned int Nbgen,std::vector< double > & dosages, double & AC, double & AF, std::vector<unsigned int> & indexforMissing);
  
  double Parse_Sparse(unsigned char * buf, size_t bufLen,  std::string & snpName, unsigned int Nbgen,std::vector< double > & dosages, double & AC, double & AF, std::vector<unsigned int> & indexforMissing, std::vector< int > & iIndex);
