...
void DesignMatrix::adjustGenotype(const double *G,
...
SPACoxMethod::SPACoxMethod(const Eigen::VectorXd &residuals,
                           double varResid,
...
std::pair<double, double> SPACoxMethod::evalK1K2(
    double t, int N0, double adjG0, const double *adjG, const uint32_t *idx, int n, double q2) const {
...
SPACoxMethod::RootResult SPACoxMethod::fastGetRootK1(
    double initX, int N0, double adjG0, const double *adjG, const uint32_t *idx, int n, double q2) const {
...
double SPACoxMethod::getProbSpa(
    double adjG0, const double *adjG, const uint32_t *idx, int n, int N0, double q2, bool lowerTail) const {
...
void SPACoxMethod::getResultVec(Eigen::Ref<Eigen::VectorXd> GVec,
                                double altFreq,
...
void runSPACox(const std::string &residFile,
    ...
    multiPhenoEngine(*genoData, tasks, outPrefix, "SPACox", compression, compressionLevel, nthread, missingCutoff,
