...
class BgenData : public GenoMeta {
  public:
    ...
    const std::string &bgenFile() const { return m_bgenFile; }
    ...
    std::streampos dataOffset() const { return m_dataOffset; }
    uint32_t bgenFlags() const { return m_bgenFlags; }
