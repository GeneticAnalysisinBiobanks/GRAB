...
// Marker4Bridge.h -- R/Rcpp boundary: per-method Rcpp entry points
//
...
//
//   [Rcpp entry points]
//     runMarkerInCPP_POLMM      — construct POLMMClass from R args; dispatch
//     runMarkerInCPP_SPACox     — construct SPACoxClass from R args; dispatch
//     runMarkerInCPP_SPAmix     — construct SPAmixClass from R args; dispatch
//     runMarkerInCPP_SPAmixPlus — construct SPAmixPlusClass from R args; dispatch
//     runMarkerInCPP_SPAGRM     — construct SPAGRMClass from R args; dispatch
//     runMarkerInCPP_SAGELD     — construct SAGELDClass from R args; dispatch
//     runMarkerInCPP_WtCoxG     — construct WtCoxGClass, populate wtMap; dispatch
//     runMarkerInCPP_SPAsqr     — construct SPAsqrClass from R args; dispatch
//     runMarkerInCPP_LEAF       — construct LEAFClass, populate leafMaps; dispatch
...
// File-static extra params: WtCoxG and LEAF populate before calling runEngineCore.
...
void runMarkerInCPP_SAGELD(
    ...
    arma::vec R_GRM_R, arma::vec R_GRM_R_nonOutlier,
