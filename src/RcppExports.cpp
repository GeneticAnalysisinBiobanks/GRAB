...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< Rcpp::List >::type t_ThreeSubj_list_lst(t_ThreeSubj_list_lstSEXP);
    Rcpp::traits::input_parameter< double >::type t_SPA_Cutoff(t_SPA_CutoffSEXP);
    Rcpp::traits::input_parameter< double >::type t_zeta(t_zetaSEXP);
    Rcpp::traits::input_parameter< double >::type t_tol(t_tolSEXP);
    setSPAsqrobjInCPP(t_taus, t_Resid_mat, t_Resid_unrelated_outliers_lst, t_sum_R_nonOutlier_vec, t_R_GRM_R_nonOutlier_vec, t_R_GRM_R_TwoSubjOutlier_vec, t_R_GRM_R_vec, t_MAF_interval, t_TwoSubj_list_lst, t_ThreeSubj_list_lst, t_SPA_Cutoff, t_zeta, t_tol);
    return R_NilValue;
END_RCPP
}
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_GRAB_setSPAsqrobjInCPP", (DL_FUNC) &_GRAB_setSPAsqrobjInCPP, 13},
    {NULL, NULL, 0}
};
