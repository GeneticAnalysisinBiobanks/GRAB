...
TextWriter::TextWriter(TextWriter&& o) noexcept
    : m_mode(o.m_mode), m_fp(o.m_fp), m_gz(o.m_gz),
      m_zctx(o.m_zctx), m_closed(o.m_closed)
{
    o.m_fp = nullptr; o.m_gz = nullptr; o.m_zctx = nullptr;
    o.m_closed = true;
}
...
void TextWriter::write(const char* data, size_t len) {
    ...
    case Mode::Zstd: {
        ...
        while (in.pos < in.size) {
            ...
            if (out.pos > 0)
                std::fwrite(outBuf, 1, out.pos, m_fp);
        }
        break;
    }
    default:
...
void TextWriter::close() {
    ...
    if (m_zctx) { ZSTD_freeCCtx(static_cast<ZSTD_CCtx*>(m_zctx)); m_zctx = nullptr; }
    if (m_gz)   { gzclose(static_cast<gzFile>(m_gz)); m_gz = nullptr; }
    ...
    : m_mode(inferMode(path))
{
    ...
    case Mode::Zstd: {
        ...
        if (!dctx) { std::fclose(fp); m_zfp = nullptr;
...
TextReader::TextReader(TextReader&& o) noexcept
    : m_mode(o.m_mode), m_fp(o.m_fp), m_gz(o.m_gz),
      m_zdctx(o.m_zdctx), m_zfp(o.m_zfp), m_closed(o.m_closed),
      m_zInBuf(o.m_zInBuf), m_zOutBuf(o.m_zOutBuf),
      m_zInPos(o.m_zInPos), m_zInSize(o.m_zInSize),
      m_zOutPos(o.m_zOutPos), m_zOutSize(o.m_zOutSize),
      m_zEof(o.m_zEof)
{
    o.m_fp = nullptr; o.m_gz = nullptr; o.m_zdctx = nullptr;
    o.m_zfp = nullptr; o.m_zInBuf = nullptr; o.m_zOutBuf = nullptr;
    o.m_closed = true;
}
...
void TextReader::close() {
    if (m_closed) return;
    m_closed = true;
    if (m_zdctx) { ZSTD_freeDCtx(static_cast<ZSTD_DCtx*>(m_zdctx)); m_zdctx = nullptr; }
    delete[] m_zInBuf;  m_zInBuf = nullptr;
    delete[] m_zOutBuf; m_zOutBuf = nullptr;
    if (m_zfp) { std::fclose(m_zfp); m_zfp = nullptr; }
    if (m_gz)  { gzclose(static_cast<gzFile>(m_gz)); m_gz = nullptr; }
    if (m_fp)  { std::fclose(m_fp); m_fp = nullptr; }
}
