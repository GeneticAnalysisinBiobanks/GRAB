...
private:
    ...
    double K0(double t, const double* cMat, const double* muSub,
              int nSub, int Jm1, double Ratio0, double m1) const;
    double K1(double t, const double* cMat, const double* muSub,
              int nSub, int Jm1, double Ratio0, double m1) const;
    double K2(double t, const double* cMat, const double* muSub,
