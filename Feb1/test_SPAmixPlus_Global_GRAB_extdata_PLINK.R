...
GenoFile = paste0(GRAB_extdata_dir, "/simuPLINK.bed")
...
OutputFile_SPAmixPlus_Global_v1 = paste0(output_dir,"/Output_SPAmixPlus_Global_v1_PLINK.txt")
...
af_model_db = paste0(output_dir, "/SPAmixPlus_AF_Estimates_PLINK.bin")
