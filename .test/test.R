...
GRAB.Marker4(obj.SPAGRM, GenoFile, mt_spagrm, control = control, overwrite = TRUE)
GRAB.Marker4(obj.SPAsqr, GenoFile, mt_spasqr, control = control, overwrite = TRUE)
GRAB.Marker4(obj.WtCoxG, GenoFile, mt_wtcoxg, control = control, overwrite = TRUE)
GRAB.Marker4(obj.LEAF, GenoFile, mt_leaf, control = control, overwrite = TRUE)
GRAB.Marker4(obj.SPACox, GenoFile, mt_spacox, control = control, overwrite = TRUE)
GRAB.Marker4(obj.SPAmix, GenoFile, mt_spamix, control = control, overwrite = TRUE)
GRAB.Marker4(obj.SPAmixPlus, GenoFile, mt_spamixplus, control = control, overwrite = TRUE)
GRAB.Marker4(obj.POLMM, GenoFile, mt_polmm, control = control, overwrite = TRUE)
GRAB.Marker4(obj.SAGELD, GenoFile, mt_sageld, control = control, overwrite = TRUE)
