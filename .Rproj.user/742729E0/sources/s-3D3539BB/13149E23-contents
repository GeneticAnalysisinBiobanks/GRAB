                       ...
                       control = NULL)
{
  ...
  print(paste0("We split all markers to ", length(marker.list), " blocks, each of which includes no more than ", nMarkers_output, " markers."))
