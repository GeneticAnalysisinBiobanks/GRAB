...
namespace BGEN {
		 ...
		 std::vector< double > & t_dosages)
  {
    ...
    if(!m_isQuery){
      ...
      unsigned int m_N0_temp = m_gm_context.number_of_samples;
      m_N0 = int(m_N0_temp);
      ...
      //printf("4\n");fflush(NULL);
      unsigned int m_M0_temp = m_gm_context.number_of_variants;
      m_M0 = m_M0_temp;
			 ...
			 std::vector<double> & t_dosage)
  {
    ...
    unsigned int Nbgen = m_gm_context.number_of_samples;
    t_ac = 0;
    t_freq = 0;
  ...
  double  BgenClass::Parse(unsigned char * buf, size_t bufLen,  std::string & snpName, unsigned int Nbgen,std::vector< double > & dosages, double & AC, double & AF, std::vector<unsigned int> & indexforMissing){
  ...
  double  BgenClass::Parse_Sparse(unsigned char * buf, size_t bufLen,  std::string & snpName, unsigned int Nbgen,std::vector< double > & dosages, double & AC, double & AF, std::vector<unsigned int> & indexforMissing, std::vector< int > & iIndex){
