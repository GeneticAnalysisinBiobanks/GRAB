...
getPairwiseIBD = function(PlinkFile,            # a path to PLINK file (without file extensions of bed/bim/fam).
                          SparseGRMFile,        # a path to SparseGRMFile from getSparseGRM() function.
                          PairwiseIBDFile,      # a path to save pairwise IBD to PairwiseIBDFile.
                          frqFile = NULL,       # a path to frq file corresponding to Plink file, default is PlinkFile.
                          tempDir = NULL,       # a path to save the temp files.
