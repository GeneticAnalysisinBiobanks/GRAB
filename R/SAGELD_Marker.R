...
runMarker.SAGELD <- function(objNull, control, bedFile, bimFile, famFile,
                             OutputFile, nThreads) {
  ...
  runMarkerInCPP.SAGELD(
    ...
    R_GRM_R_G                       = objNull$R_GRM_R_G,
    R_GRM_R_GxE                     = objNull$R_GRM_R_GxE,
    R_GRM_R_G_GxE                   = objNull$R_GRM_R_G_GxE,
    R_GRM_R_E                       = objNull$R_GRM_R_E,
    R_GRM_R_nonOutlier              = objNull$R_GRM_R_nonOutlier,
    R_GRM_R_nonOutlier_G            = objNull$R_GRM_R_nonOutlier_G,
    R_GRM_R_nonOutlier_GxE          = objNull$R_GRM_R_nonOutlier_GxE,
    R_GRM_R_nonOutlier_G_GxE        = objNull$R_GRM_R_nonOutlier_G_GxE,
    R_GRM_R_TwoSubjOutlier          = objNull$R_GRM_R_TwoSubjOutlier,
    R_GRM_R_TwoSubjOutlier_G        = objNull$R_GRM_R_TwoSubjOutlier_G,
    R_GRM_R_TwoSubjOutlier_GxE      = objNull$R_GRM_R_TwoSubjOutlier_GxE,
    R_GRM_R_TwoSubjOutlier_G_GxE    = objNull$R_GRM_R_TwoSubjOutlier_G_GxE,
